/** @public */
export declare const toolboxTranslationRef: import("@backstage/core-plugin-api/alpha").TranslationRef<"toolbox", {
...
export declare const toolboxTranslations: import("@backstage/core-plugin-api/alpha").TranslationResource<"toolbox">;
